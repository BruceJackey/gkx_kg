...
export type RecognitionPanelLabels = {
  highlight?: string;
  review?: string;
  linking?: string;
  intro?: string;
 ...
 */
export function RecognitionResultManagementPanel({
  initialFocus,
  labels,
  showLinking = true,
  ...
  const linkingTitle = labels?.linking ?? '实体链接与消歧';
  const intro =
    labels?.intro ??
  ...
  return (
    <div className="flex flex-col gap-4 flex-1 min-h-0 overflow-hidden">
      ...
      <div className="flex items-center gap-3 flex-wrap flex-shrink-0 text-xs">
      ...
      <div className="flex gap-4 flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto space-y-4 min-h-0">
          <section
            id="recog-highlight"
            className={`bg-white border rounded-xl overflow-hidden ${initialFocus === 'highlight' ? 'border-blue-300 ring-1 ring-blue-100' : 'border-gray-200'}`}
          >
            <div className="px-4 py-2.5 border-b border-gray-100 flex items-center gap-2 bg-gray-50">
              ...
              <span className="text-sm font-semibold text-gray-800">{highlightTitle}</span>
          ...
          >
            <div className="px-4 py-2.5 border-b border-gray-100 flex items-center gap-2 bg-gray-50">
              ...
              <span className="text-sm font-semibold text-gray-800">{reviewTitle}</span>
            </div>
